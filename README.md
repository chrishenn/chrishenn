...
For the past ~2 years, I've been employing these tools to design novel computer vision model-architectures - and investigate hypotheses about the fundamental structure of image data (and by extension, how we model the structure of data in general). 
